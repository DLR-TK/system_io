...
//import io.netty.service.codec.ByteToMessageDecoder;
...
//                .service(new ChannelInitializer<NioSocketChannel>() {
//                    @Override
//                    protected void initChannel(NioSocketChannel ch) throws Exception {
...
//        while (buf.readableBytes() >= 100) { //int 100    long 104
//            //读取信息头
...
//
//            //获取信息体
//            if (buf.readableBytes() >= (header.getDataLength() + 100)) {
//                //移动指针
//                buf.readBytes(100);
